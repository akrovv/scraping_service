...
class UserUpdateForm(forms.Form):
    city = forms.ModelChoiceField(required=True, queryset=City.objects.all(), to_field_name="slug",
                                  widget=forms.Select(
        attrs={
            'class': 'form-control'
        }
    ), label="Город")
    language = forms.ModelChoiceField(required=True, queryset=Language.objects.all(), to_field_name="slug",
                                      widget=forms.Select(
        attrs={
            'class': 'form-control'
        }
